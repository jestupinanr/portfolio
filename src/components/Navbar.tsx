    ...
    >
      <ul className="flex gap-2">
        <li className={`relative rounded-full bg-[#212121] drop-shadow w-10 h-10 flex justify-center items-center cursor-pointer flex-col gap-2`}>
          <a href="/">
          <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-home" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#7e7e7e" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <li className="rounded-full bg-[#212121] drop-shadow w-10 h-10 flex justify-center items-center cursor-pointer">
          <a href="/">
          <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-briefcase" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#7e7e7e" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        ...
        <li className="rounded-full bg-[#212121] drop-shadow w-10 h-10 flex justify-center items-center cursor-pointer">
          <a href="/">
          <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-user" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#7e7e7e" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        ...
        <li className="rounded-full bg-[#212121] drop-shadow w-10 h-10 flex justify-center items-center cursor-pointer">
          <a href="/">
            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-address-book" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#7e7e7e" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
      ...
      <ul className="flex gap-2">
        <li className="rounded-full bg-[#212121] drop-shadow w-10 h-10 flex justify-center items-center cursor-pointer">
          <a href="/">
          <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-linkedin" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#7e7e7e" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        ...
        <li className="rounded-full bg-[#212121] drop-shadow w-10 h-10 flex justify-center items-center cursor-pointer">
          <a href="/">
          <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-github" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#7e7e7e" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        ...
        <li className="rounded-full bg-[#212121] drop-shadow w-10 h-10 flex justify-center items-center cursor-pointer">
          <a href="/">
          <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-mail" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#7e7e7e" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
      ...
      <ul className="flex gap-2">
        <li className="rounded-full bg-[#212121] drop-shadow w-10 h-10 flex justify-center items-center cursor-pointer">
          <a href="/">
          <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-moon" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#7e7e7e" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
